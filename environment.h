...
public:
	...
	//BEGIN_STAGE_THREE
    virtual void traceGlobalPhotons(Photon * globalPhotons, int nGlobalPhotons)
    {
        return;
    }

    virtual void traceGlobalPhotons(Photon * globalPhotons, int nGlobalPhotons, KD::Tree<CORE> *kdGlobal)
    {
        return;
    }
	//BEGIN_STAGE_THREE
